...
export default function TopNav({ digitalWall = false, chat = false, connections = false, notifications = false, job = false }) {
    ...
    return (
        <div className=' flex-1 bg-gradient-to-r from-primary z-10  to-secondary  py-2 w-96 sticky top-0 rounded-b-xl mx-auto mb-2 justify-between px-10 hidden lg:flex '>
